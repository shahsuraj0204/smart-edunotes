  ...
  return (
    <div className="relative mt-10 flex flex-1 flex-col items-center justify-center px-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full bg-gradient-to-tr from-[var(--gradient-end)]/20 to-transparent blur-3xl" />
      </div>
      ...
      <Card className="relative w-full max-w-md glass-effect border-border/30 shadow-2xl card-hover">
        ...
        <CardHeader className="space-y-4 pb-2">
          {/* Icon */}
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl gradient-bg shadow-lg">
